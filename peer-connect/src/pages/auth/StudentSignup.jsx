...
const StudentSignup = () => {
  ...
  const getStepButtonClass = (step) => {
    if (step === currentStep) {
      ...
      (step === 'account') ||
      (step === 'school' && currentStep === 'confirm')
    ) {
            ...
            <main >
                ...
                <div className="w-full max-w-md">
                    ...
                    <button
                        ...
                        className={`py-3 px-4 text-sm font-medium rounded-l-lg border border-r-0 border-gray-600 flex items-center justify-center gap-2 ${getStepButtonClass('account')}`}
                    >
                        <User size={16} />
                        Account
                    </button>
                    <button
                        onClick={() => currentStep !== 'account' && setCurrentStep('school')}
                        className={`py-3 px-4 text-sm font-medium border border-gray-600 flex items-center justify-center gap-2 ${getStepButtonClass('school')}`}
                    ...
                    <button
                        ...
                        className={`py-3 px-4 text-sm font-medium rounded-r-lg border border-l-0 border-gray-600 flex items-center justify-center gap-2 ${getStepButtonClass('confirm')}`}
